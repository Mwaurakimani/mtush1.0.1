...
<section class="Content">
    <div class="content_view_header">
        ...
        <ul class="bread_crumbs">
            <li>
                <ul>
                    <li class="linker" onclick="renderContent('moderators')">List</li>
                </ul>
            </li>
        </ul>
    </div>
    <div class="content_view_options">
        <div class="action_buttons">
            <button type="button" class="btn btn-outline-danger" id="addUser" onclick="openUserAccount()">Add User</button>
